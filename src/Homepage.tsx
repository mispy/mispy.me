...
export default class Homepage extends React.Component<{ assets: { [key: string]: string } }> {
    render() {
        const description = `Hi, I'm Mispy! I work part-time as a freelance web developer, and in my spare time I do some projects you can find on this site.`
        ...
        return <main className={styles.homepage}>
            ...
            <section className="intro">
                <div>
                    <h1>Mispy</h1>
                    <p>Hi, I'm Mispy! I work part-time as a freelance web developer, and in my spare time I do some projects you can find on this site. I have a loose background in science (originally studied biology).</p>
                    ...
                    <p>I'm a little shy, but I like to make cool new internet friends, so feel free to send me a message!</p>
                </div>
                <footer>
                    <div>
                        <a href="mailto:mispy@mispy.me">mispy@mispy.me</a> • <a href="https://twitter.com/mispy11">@mispy11</a>
                        <HeartButton />
                    </div>
